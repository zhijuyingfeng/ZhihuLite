...
/** Tag names are normalised by both the parser and the renderer, so this is module API. */
 ...
 * the lock.
 */
/** Parse-tree cache; public so the app module's suite can assert its bound and reuse. */
